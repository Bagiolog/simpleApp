...
public class albumDue extends Fragment {
    String[] nomi={"fjsifnsonofsanf","fdsfasdfa","fdsfsafasd","fdsafdsaf","fdsdsafd","fdsaf","fsfsd","WeGuagliò","Kittemmuort","Maradona"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerViewAdapter customAdapter = new RecyclerViewAdapter(nomi,getContext());
